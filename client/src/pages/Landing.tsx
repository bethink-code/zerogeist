  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6">
      <div className="max-w-sm w-full text-center space-y-12">
        ...
        {/* Error message */}
        {error === "access_denied" && (
          <div className="bg-[var(--zg-surface)] border border-[var(--zg-border)] rounded-lg p-4 text-sm text-[var(--zg-muted)]">
            This is a private space. Access is by invitation only.
          </div>
        )}
